...
<Row>
  ...
  <Properties>
    ...
    <Property name="input" type="string" required="true">
        Input prompt for the task.
    </Property>
    <Property name="additional_input" type="object" required="false">
...
<Row>
  ...
  <Properties>
    ...
    <Property name="file" type="string" required="undefined">
        File to upload. (The example is 'Washington' in binary)
    </Property>
    <Property name="uri" type="string" required="undefined">
        URI of the artifact.
    </Property>
  </Properties>
