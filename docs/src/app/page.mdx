...
<div className="not-prose mb-16 mt-6 flex gap-3">
  ...
  <Button href="https://github.com/e2b-dev/agent-protocol" variant="outline" children="GitHub" />
</div>
...
If you're interested in the Agent Protocol, come to discuss on <Link href="https://discord.gg/bJnNh666C3">Discord</Link>.
