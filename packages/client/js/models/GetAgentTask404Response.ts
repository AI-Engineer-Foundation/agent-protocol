...
export function GetAgentTask404ResponseFromJSON(
  json: any
): GetAgentTask404Response {
  return GetAgentTask404ResponseFromJSONTyped(json, false)
}

export function GetAgentTask404ResponseFromJSONTyped(
  json: any,
...
export function GetAgentTask404ResponseToJSON(
  value?: GetAgentTask404Response | null
): any {
  if (value === undefined) {
    return undefined
  }
