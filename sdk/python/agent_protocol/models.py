...
#   timestamp: 2023-08-16T14:45:39+00:00
...
class Artifact(BaseModel):
    ...
    saved: Optional[bool] = Field(
        None,
        description="Whether the artifact has been saved to the agent's workspace.",
        example=False,
    )
    ...
    data: Optional[str] = Field(None, description="Data of the artifact.")
